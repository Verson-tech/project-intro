  ...
  <Container>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="me-auto">
       ...
       <Nav.Link id="bank-app" as={Link} to={"/home"}>Full-Stack Banking Application</Nav.Link>

        <Nav.Link id = "resto-app" as={Link} to={"/about"}>Full-Stack Restaurant Application</Nav.Link>
